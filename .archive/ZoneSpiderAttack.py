...
if id_joueur == 1:
    zones = [
        lambda entitee : 4500 <entitee.x< 9500 and 0 <entitee.y< 5000,
        lambda entitee : 2500 <entitee.x< 8500 and 2500 <entitee.y< 6500,
        lambda entitee : 0 <entitee.x< 6500 and 4500 <entitee.y< ymax
    ]
else :
    zones = [
        lambda entitee : 9500 <entitee.x< xmax and 0 <entitee.y< 5000,
        lambda entitee : xmax-6500 <entitee.x< xmax-2500 and 2500 <entitee.y< 6500,
        lambda entitee : 9500 <entitee.x< xmax-4500 and 4500 <entitee.y< ymax
    ]
